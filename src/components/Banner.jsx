            ...
            <div className="banner-container">
                ...
                <div className="banner-text2">
                    <div className="subtitle-text2">
                        Soluções para medição de líquidos, vapor e gases<br/>
                        Transmissor de pressão e nível<br/>
                        Instrumentos analíticos de processo<br/>
                        Serviços de calibração em campo com medidor ultrassônico ou skid móvel.
                    </div>
                </div>
            </div>
        </Container>
